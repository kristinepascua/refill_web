...
Built with Django 4.1 + Django REST Framework.

Gap fixes applied:
  - JWT authentication via djangorestframework-simplejwt
  - Gmail SMTP email verification via Djoser
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'refill_web'),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'oberes.khyrellenhoraine22@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'jqnb mmyg cyam xvua')
DEFAULT_FROM_EMAIL = 'oberes.khyrellenhoraine22@gmail.com'
